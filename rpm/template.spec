...
%global pkg_name at_sonde_ros_driver
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-at-sonde-ros-driver
Version:        1.0.0
Release:        3%{?dist}
...
%description
A ROS 2 driver to stream the monitored parameters of an In-Situ Aqua TROLL
...
%changelog
* Wed Apr 29 2026 MA Song <song.ma.18@ucl.ac.uk> - 1.0.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 MA Song <song.ma.18@ucl.ac.uk> - 1.0.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 MA Song <song.ma.18@ucl.ac.uk> - 1.0.0-1
- Autogenerated by Bloom
